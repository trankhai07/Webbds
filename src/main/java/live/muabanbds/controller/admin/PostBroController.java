...
@WebServlet (urlPatterns = "/admin-browse")
public class PostBroController extends HttpServlet {
...
//            req.setAttribute("lst1",lst1);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String url = null;
        if(type!=null && type.equals(SystemConstant.EDIT)) {
            if(postModel.getId()!= null) {
                postModel = postDAO.findOne(postModel.getId());
            }
            request.setAttribute("editBr", "yes");
